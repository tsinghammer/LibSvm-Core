...
namespace libsvm
{
	...
	public class svm
	{
		...
		public static byte[] svm_save_model(System.String model_file_name, svm_model model)
		{
            ...
            System.IO.StreamWriter fp = new System.IO.StreamWriter(new System.IO.MemoryStream());
            ...
            byte[] sBytes = unicodeEncoding.GetBytes(fp.ToString());
            return sBytes;
		}
		...
		public static svm_model svm_load_model(byte[] modelToLoad)
		{
            ...
            //System.Text.UnicodeEncoding unicodeEncoding = new System.Text.UnicodeEncoding();
            //byte[] sBytes = unicodeEncoding..GetString(modelToLoad);
            System.IO.StreamReader fp = new System.IO.StreamReader(new System.IO.MemoryStream(modelToLoad));
